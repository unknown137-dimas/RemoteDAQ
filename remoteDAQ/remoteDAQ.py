...
def do_daq(devDesc, portList, data):
   '''
   Function to Output Digital Signal
   '''
   ret = ErrorCode.Success
...
if __name__ == '__main__':
   ...
   while True:
      data = [line_protocol(measurement_name=name, channel=channel, value=value) for name, channel, value in ai_daq(devDesc=devDesc, portList=[i for i in range(0,8)])]
